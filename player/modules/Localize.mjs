...
"extension_name": "FastStream Video Player",
  ...
  "player_subtitlesmenu_shifttool_message": "Shifted subtitles $1s",
  "player_testsubtitle": "This is a test subtitle",
  "player_qualitymenu_label": "Video quality",
  "player_languagemenu_label": "Language selection",
  "player_languagemenu_video": "Video",
  "player_languagemenu_audio": "Audio",
  ...
  "options_update_header": "An Update is Available!",
  "options_update_body": "FastStream v$1 is now available (current version v$2). Would you like to update?",
  "options_update_go": "Take me to Github",
  "options_update_no": "Ignore this update",
  ...
  "options_general_storeprogress": "Save progress of videos in local storage",
  ...
  "options_general_autoplayyt": "Autoplay YouTube videos",
  "options_general_quality": "Quality multiplier factor for quality selection algorithm (higher will choose higher quality)",
  "options_general_clickaction": "Single click action",
  "options_general_dblclickaction": "Double click action",
  "options_general_tplclickaction": "Triple click action",
  "options_general_clickaction_playpause": "Toggle play/pause",
  "options_general_clickaction_fullscreen": "Toggle fullscreen",
  "options_general_clickaction_pip": "Toggle picture-in-picture",
  "options_general_clickaction_hidecontrols": "Hide controls",
  "options_general_clickaction_hideplayer": "Hide player",
  "options_general_vischangeaction": "When player visiblity changes",
  "options_general_vischangeaction_nothing": "Do nothing",
  "options_general_vischangeaction_playpause": "Toggle play/pause",
  "options_general_vischangeaction_miniplayer": "Toggle miniplayer",
  "options_general_minipos": "Miniplayer position",
  "options_general_minipos_topleft": "Top Left",
  "options_general_minipos_topright": "Top Right",
  "options_general_minipos_bottomleft": "Bottom Left",
  "options_general_minipos_bottomright": "Bottom Right",
  "options_general_minisize": "Miniplayer size",
  "options_general_vischangeaction_pip": "Toggle picture-in-picture",
  "options_export_header": "Import/Export Settings",
  "options_import": "Import Settings From File",
  "options_export": "Export Settings To File",
  ...
  "options_pattern_header": "Custom Source Patterns",
